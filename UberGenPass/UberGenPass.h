...
#define NavigationBarLandscapeHeight 32
#define NavigationBarPortraitHeight 44
#define ToolBarLandscapeHeight 32
#define ToolBarPortraitHeight 44
...
#define AppNameString @"AppName"
#define OKString @"OK"
#define RecentSitesString @"RecentSites"
